  ...
  <body>
    ...
    <?php
      ...
      $file_name = 'file';
        ...
        if (isset($_FILES['image_field']) and $_POST['caption'] != '' and $_POST['privacy'] != '' and isset($_SESSION['user']) and $_SESSION['user'] != '') 
        {
          ...
          if ($handle->uploaded) {
              ...
              if ($handle->processed) {
                  ...
                  echo $_POST['privacy'];
                  echo '</p>';
                  new_post($db, username(), $_POST['caption'], $url, $_POST['privacy']);
              } else {
                  // one error occured
                  echo '<p class="result">';
    ...
    <form name="form1" enctype="multipart/form-data" method="post" action="">
      ...
      <div class="wrapper">
        <div class="box-0">
          <textarea name="caption" class="form-control" placeholder="Caption"></textarea><br/>
